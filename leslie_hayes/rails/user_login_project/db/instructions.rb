...
# Here we have defined our own regular expression, EMAILREGEX, to match the pattern of a valid email address. We're validating that our email is unique in our database (without worrying about casesensitivity) and we're making sure that it is formatted correctly using our EMAIL_REGEX regular expression.
...
# Check out Active Record Validations documentation.
